module DirectoryUsers
  ...
  class RemoteHeader < Liquid::Tag
    ...
    def render(context)
      ...
      puts user.inspect
      user["header_remote_url"] || "/assets/images/missing_avatar.png"
    end
  end
...
Liquid::Template.register_tag('directory_user_header', DirectoryUsers::RemoteHeader)
